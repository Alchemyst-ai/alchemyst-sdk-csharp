...
public class MemoryAddResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new MemoryAddResponse
        {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<MemoryAddResponse>(json);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<MemoryAddResponse>(element);
    ...
    {
        var model = new MemoryAddResponse { ContextID = "ctx_01HXYZABC", Success = true };
