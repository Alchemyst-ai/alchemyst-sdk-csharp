...
using AlchemystAISDK.Models.V1.Context.ContextAddParamsProperties;
using ContextSearchParamsProperties = AlchemystAISDK.Models.V1.Context.ContextSearchParamsProperties;
